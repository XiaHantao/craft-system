...
/**
 * 五类/七类车标准配置对象 categoryfive_standard_configuration_table
 * 
 * @author ruoyi
 * @date 2025-03-07
 */
public class CategoryfiveStandardConfigurationTable extends BaseEntity
{
    ...
    /** 行走OPS功能 */
    @Excel(name = "行走OPS功能")
    private String walkingOpsFunction;
    ...
    /** 中位排气 */
    @Excel(name = "中位排气")
    private String medianExhaust;

    /** 高排气 */
    @Excel(name = "高排气")
    private String highExhaust;

    /** 两驱 */
    @Excel(name = "两驱")
    private String twoWheelDrive;
    ...
    /** 牙嵌式差速锁 */
    @Excel(name = "牙嵌式差速锁")
    private String dentalEmbeddedDifferentialLock;
    ...
    public void setTwinTires(String twinTires) 
    {
        this.twinTires = twinTires;
    }

    public String getTwinTires() 
    {
        return twinTires;
    }
    ...
    public void setWalkingOpsFunction(String walkingOpsFunction) 
    {
        this.walkingOpsFunction = walkingOpsFunction;
    }

    public String getWalkingOpsFunction() 
    {
        return walkingOpsFunction;
    }
    ...
    public void setMedianExhaust(String medianExhaust) 
    {
        this.medianExhaust = medianExhaust;
    }

    public String getMedianExhaust() 
    {
        return medianExhaust;
    }
    public void setHighExhaust(String highExhaust) 
    {
        this.highExhaust = highExhaust;
    }

    public String getHighExhaust() 
    {
        return highExhaust;
    }
    public void setTwoWheelDrive(String twoWheelDrive) 
    {
        this.twoWheelDrive = twoWheelDrive;
    }

    public String getTwoWheelDrive() 
    {
    ...
    public void setDentalEmbeddedDifferentialLock(String dentalEmbeddedDifferentialLock) 
    {
        this.dentalEmbeddedDifferentialLock = dentalEmbeddedDifferentialLock;
    }

    public String getDentalEmbeddedDifferentialLock() 
    {
        return dentalEmbeddedDifferentialLock;
    }
    public void setLimitedSlipDifferential(String limitedSlipDifferential) 
    {
        this.limitedSlipDifferential = limitedSlipDifferential;
    }
    ...
    public void setManualDifferentialLock(String manualDifferentialLock) 
    {
        this.manualDifferentialLock = manualDifferentialLock;
    }

    public String getManualDifferentialLock() 
    {
        return manualDifferentialLock;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("walkingOpsFunction", getWalkingOpsFunction())
            ...
            .append("medianExhaust", getMedianExhaust())
            .append("highExhaust", getHighExhaust())
            .append("twoWheelDrive", getTwoWheelDrive())
            .append("fourWheelDrive", getFourWheelDrive())
            .append("dentalEmbeddedDifferentialLock", getDentalEmbeddedDifferentialLock())
            .append("limitedSlipDifferential", getLimitedSlipDifferential())
            .append("manualDifferentialLock", getManualDifferentialLock())
