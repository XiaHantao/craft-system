  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="材质" prop="textureOfMaterial">
        <el-input
          v-model="queryParams.textureOfMaterial"
          placeholder="请输入材质"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="原材料物料号" prop="rawMaterialNumber">
        <el-input
          v-model="queryParams.rawMaterialNumber"
          placeholder="请输入原材料物料号"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="下料" prop="materialCutting">
        <el-input
          v-model="queryParams.materialCutting"
          placeholder="请输入下料"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="金工" prop="metalworking">
        <el-input
          v-model="queryParams.metalworking"
          placeholder="请输入金工"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="组焊" prop="assemblyWelding">
        <el-input
          v-model="queryParams.assemblyWelding"
          placeholder="请输入组焊"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="装配" prop="assembling">
        <el-input
          v-model="queryParams.assembling"
          placeholder="请输入装配"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="工装图纸" prop="toolingDrawings">
        <el-input
          v-model="queryParams.toolingDrawings"
          placeholder="请输入工装图纸"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="采购清单" prop="procurementList">
        <el-input
          v-model="queryParams.procurementList"
          placeholder="请输入采购清单"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="是否为关键部件" prop="keyComponents">
        <el-input
          v-model="queryParams.keyComponents"
          placeholder="请输入是否为关键部件"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="toolingDetailRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="序号" prop="serialNumber">
...
import { listToolingDetail, getToolingDetail, delToolingDetail, addToolingDetail, updateToolingDetail } from "@/api/ToolingModule/toolingDetail";
